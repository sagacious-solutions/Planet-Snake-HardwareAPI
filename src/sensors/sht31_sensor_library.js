// This was sourced from an existing working piece of code
// I'm not sure who original author
...
class SHT31 {
  constructor(options) {
    ...
    this.i2cBusNo =
      options && options.hasOwnProperty("i2cBusNo") ? options.i2cBusNo : 1;
    this.i2cBus = i2c.openSync(this.i2cBusNo);
    this.i2cAddress =
      options && options.hasOwnProperty("i2cAddress")
        ? options.i2cAddress
        : SHT31.SHT31_DEFAULT_I2C_ADDRESS();
    ...
    return new Promise((resolve, reject) => {
      this.i2cBus.writeByte(
        ...
        (err) => {
          ...
          this.i2cBus.readI2cBlock(
            this.i2cAddress,
            this.REGISTER_ALL_DATA,
            6,
            new Buffer(6),
